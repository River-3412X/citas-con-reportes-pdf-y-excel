...
@section('scripts')
    <script src="{{ asset('js/registrar/responsables.js') }}" type="text/javascript"></script>    
@endsection
@section('contenido')
    <div class="row">
        <div class="col-10 offset-1 col-sm-8 offset-sm-2">
            <h4>Registrar Responsables</h4>
            <form method="post" id="formulario" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="usuario" id="usuario" placeholder="Usuario" class="form-control form-control-sm">
